...
export const BOSSES: Boss[] = [
  ...
  },
  {
    id: 'bone-choir',
    name: 'The Bone Choir',
    title: 'A hundred dead things singing as one',
    maxHp: 1400,
    attack: 56,
    coinReward: 1300,
    icon: 'sparkles',
  ...
  },
  {
    ...
    title: 'It has not stopped in a thousand years',
    maxHp: 1750,
    attack: 54,
    coinReward: 1650,
    icon: 'castle',
  ...
  },
  {
    ...
    title: 'Iron lord of the lowest gate',
    maxHp: 2100,
    attack: 58,
    coinReward: 2100,
    icon: 'flame',
  ...
  },
  {
    id: 'worldeater',
    name: 'The Worldeater',
    title: 'What waits at the end of every road',
    maxHp: 2600,
    attack: 60,
    coinReward: 3000,
    icon: 'crown',
